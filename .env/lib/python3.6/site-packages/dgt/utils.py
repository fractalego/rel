...
def train_a_single_path(path, goal, metric, relation_metric, no_threshold_match, threshold_match, optimizer, epochs, permutation_shift):
...
def train_all_paths(metric, relations_metric, k, paths, goal, permutation_shift, epochs=50, step=1e-2):
