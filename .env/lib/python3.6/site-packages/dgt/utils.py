...
def train_a_single_path(path, goal, metric, relation_metric, match_factory, optimizer, epochs,
    ...
    for i in range(epochs):
        ...
        relations_pre_match, relations_post_match, relations_post_thresholds, substitutions \
            = create_list_of_states_for_relations(metric, relation_metric, graph_list,
                                                  match_factory.create_no_threshold_match(),
                                                  permutation_shift)
    ...
    for item in paths:
        ...
        try:
            for match_index in range(5):
                if train_a_single_path(item, goal, metric, relations_metric,
